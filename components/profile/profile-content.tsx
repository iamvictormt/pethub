            ...
            <div className="rounded-xl border border-border bg-card p-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between rounded-lg bg-blue-farejei/10 p-3">
                  <span className="text-sm font-medium">Pets Encontrados</span>
                ...
                <div className="flex items-center justify-between rounded-lg bg-green-found/10 p-3">
                  <span className="text-sm font-medium">Para adoção</span>
                  ...
                  {isEditing && (
                    <>
                      ...
                      <button
                        ...
                        className="absolute -bottom-2 left-1/2 flex h-12 w-12 -translate-x-1/2 items-center justify-center rounded-2xl bg-orange-alert text-white shadow-lg hover:bg-orange-alert/90 disabled:opacity-50 md:bottom-1 md:right-1 md:h-10 md:w-10 md:translate-x-0 md:left-auto cursor-pointer md:bottom-19"
                      >
                        {isUploadingAvatar ? (
